...
public :
    ...
    bool get( const char * section, const char * key, long & value );
    bool get( const char * section, const char * key, unsigned long & value );
#endif
...
private :
    ...
    // 打印日志
    void append( uint8_t level, int32_t today,
